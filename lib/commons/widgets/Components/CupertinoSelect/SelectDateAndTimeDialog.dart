...
class SelectDateAndTimeDialog extends StatefulWidget {
  ...
  @override
  _SelectDateAndTimeDialogState createState() =>
      _SelectDateAndTimeDialogState();
}
            ...
            Row(
              ...
              children: [
                Padding(
                  ...
                  child: TextButton(
                      child: Text(context.l10n.entendido,
                          style: Theme.of(context)
                              .textTheme
                              .displaySmall
                              ?.copyWith(
