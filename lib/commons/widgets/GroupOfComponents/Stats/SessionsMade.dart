    ...
    if (filteredEvents.isNotEmpty) {
      ...
      for (var i = 0; i < 12; i++) {
        ...
        eventList.removeWhere(
            (element) => element.month == currentMonth.month.toString());
        int numberOfEvents = totalEventsNumber - eventList.length;
        // Get month String
        String month =
            StringUtils().toCapitalized(formatter.format(currentMonth));
      ...
      for (var i = 0; i < 12; i++) {
        ...
        String month =
            StringUtils().toCapitalized(formatter.format(currentMonth));
        // Build Total Events Object
        TotalEvents chartEntry =
            TotalEvents(month, (currentMonth.month * Random().nextInt(i + 1)));
        // Add to Temp Variables
        yearList.insert(0, chartEntry);
        if (i < 6) sixMonthsList.insert(0, chartEntry);
        // Update Values
        ...
        children: [
          SfCartesianChart(
              ...
              primaryXAxis: CategoryAxis(
                ...
                majorTickLines:
                    const MajorTickLines(width: 0.5, color: Colors.transparent),
                // Minor Lines
