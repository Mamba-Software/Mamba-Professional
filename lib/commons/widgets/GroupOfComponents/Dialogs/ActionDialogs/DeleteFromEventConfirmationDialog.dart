...
class DeleteFromEventConfirmationDialog extends StatefulWidget {
  final String text;
  final String userId;
  const DeleteFromEventConfirmationDialog(
      {super.key, required this.text, required this.userId});

  @override
  _DeleteFromEventConfirmationDialogState createState() =>
      _DeleteFromEventConfirmationDialogState();
}

class _DeleteFromEventConfirmationDialogState
    extends State<DeleteFromEventConfirmationDialog> {
