    ...
    return isLoading
        ...
        : Scaffold(
            ...
            body: StreamBuilder<QuerySnapshot>(
                stream:
                    _eventDataService.getBrandsEventsTodayStream(_brand.id!),
                builder: (context, snapshot) {
                  if (snapshot.data == null) {
                    ...
                    return SfCalendar(
                      ...
                      minDate: DateTime(dateJoined.year, dateJoined.month,
                          dateJoined.day, _startHour!.toInt() - 1, 0),
                      maxDate: DateTime(dateJoined.year, dateJoined.month,
                          dateJoined.day, _endHour!.toInt() + 1, 0),
                      headerHeight: 0,
                      viewHeaderHeight: 0,
                      ...
                      appointmentBuilder: (BuildContext context,
                        ...
                        return GestureDetector(
                          onTap: () {
                            _viewEvent(appointment.id.toString(),
