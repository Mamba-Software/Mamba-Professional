...
class _BrandEventCardState extends State<BrandEventCard> {
  ...
  Widget buildEventFeedbackText() {
    if (widget.event.averageIntensityScore == null) {
      ...
      return Text(widget.event.averageIntensityScore!.toStringAsFixed(1),
          style: Theme.of(context)
              .textTheme
              .bodyMedium
              ?.copyWith(color: AppColors.black),
  ...
  Widget buildEventFeedbackEntries() {
    if (widget.event.averageIntensityScore == null) {
      ...
      return Row(
        children: [
          Text("/ ${widget.event.feedbackEntries}",
              style: Theme.of(context)
                  .textTheme
                  .bodyMedium
                  ?.copyWith(color: AppColors.black),
              textAlign: TextAlign.center),
          Icon(Icons.person, size: widget.width * 0.05, color: AppColors.black)
        ],
      );
    }
  }
            ...
            SizedBox(
              ...
              child: Column(
                ...
                children: [
                  Padding(
                    padding:
                        EdgeInsets.symmetric(horizontal: widget.height * 0.1),
                    child: Row(
                  ...
                  isCompleted
                      ...
                      : Row(
                          ...
                          children: [
                            Padding(
                              padding:
                                  EdgeInsets.only(left: widget.height * 0.1),
                              child: Text(
                                "${DateFormat('Hm', Localizations.localeOf(context).languageCode).format(startDate)} - ${DateFormat('Hm', Localizations.localeOf(context).languageCode).format(endDate)}",
                                style: Theme.of(context)
                                    .textTheme
