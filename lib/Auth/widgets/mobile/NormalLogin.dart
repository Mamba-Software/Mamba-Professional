...
Widget normalLogin(BuildContext context, AuthState state,  final _formKey, String email, String password) {
  ...
  return GestureDetector(
    onTap: () async {
      if(_formKey.currentState!.validate()){
        ...
        context.read<AuthCubit>().generalSignIn(AuthProviderEnum.normal, context, email, password);
      }
    },
    child: Material(
      elevation: 4,
      ...
      child: Container(
        ...
        child: checkIfProvider(state, AuthProviderEnum.normal) ? Center(
          child: Text(
