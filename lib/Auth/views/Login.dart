  ...
  Widget initialLogIn(AuthState state) {
    return Container(
          ...
          child: Column(
            ...
            children: [
              Platform.isAndroid == false ? appleLogin(context, state) : Container(),
                ...
                onPressed: () async {
                  ...
                  if (Localizations
                    ...
                    if (!await launchUrl(Uri.parse(
                        termsAndConditionsES))) throw 'Could not launch $termsAndConditionsES';
                  } else if (Localizations
                      .localeOf(context)
                      .languageCode == 'ca') {
                    if (!await launchUrl(Uri.parse(
                        termsAndConditionsCA))) throw 'Could not launch $termsAndConditionsCA';
                  } else {
                    if (!await launchUrl(Uri.parse(
                        termsAndConditionsES))) throw 'Could not launch $termsAndConditionsES';
                  }
    ...
    void showInSnackBar(String value,
        [String valueBody = "", bool isClickable = false, bool resendEmail = false]) {
      Widget snackbar;
      if (isClickable) {
        snackbar = SnackBar(
