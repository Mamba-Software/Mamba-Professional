...
Widget warningBonos(BuildContext context, Map<Bono, bool> eventBonosMap) {
  return kIsWeb
      ...
      Padding(
        ...
        child: Column(
          children: [
            ...
            warningBonos(context, eventBonosMap),
          ],
        ),
      ),
      kIsWeb
          ? bonosListWeb(context, eventBonosMap, hasBonos)
          : hasBonos
              ? eventBonosMap.isNotEmpty
                  ? Column(
                      children: [
