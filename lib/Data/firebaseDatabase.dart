...
class FirebaseDatabaseService {
  ...
  Future<String> addConversation(String? id, List<String>? users,
      String? brandId, String? time, String? lastMessage) async {
    var uid = Uuid().v1();
    try {
  ...
  Stream<QuerySnapshot> getUserConversations(Usuario user) {
    return _firestore
