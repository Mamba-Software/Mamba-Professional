...
class PurchaseDataService {
  ...
  Future<List<Purchase>> getBrandUserPurchases(String userId, String brandId, DateTime startDate, DateTime endDate, [bool applyThreshold = false]) => _firebase.getBrandUserPurchases(userId, brandId, startDate, endDate, applyThreshold);
  ...
  Future<void> updatePurchasePaymentStatus(String purchaseId, bool isPaid) => _firebase.updatePurchasePaymentStatus(purchaseId, isPaid);
