...
class BrandDataService {
  ...
  // Update Data
  Future<void> updateBrandInfo(String brandID, String name,String description, int maxMembers, List<double> workShift, int bookingWindow, bool? directPurchase, bool? freeSession) => _firebase.updateBrandInfo(brandID, name, description, maxMembers, workShift, bookingWindow, directPurchase, freeSession);
