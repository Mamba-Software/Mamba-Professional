...
class LocationDataService {
  ...
  Future<List<Location>> getAllBrandLocations(String brandId) => _firebase.getAllBrandLocations(brandId);
  Future<double> getLocationPercentatgeEvents(String brandId, String locationId) => _firebase.getLocationPercentatgeEvents(brandId, locationId);
