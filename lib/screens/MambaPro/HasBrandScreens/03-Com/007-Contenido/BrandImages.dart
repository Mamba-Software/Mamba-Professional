...
class _BrandImagesState extends State<BrandImages>
  ...
  Future<void> getBrandContentImages() async {
    ...
    if (_imagesUploaded.isNotEmpty) {
      // Find the base image
      baseImage = _imagesUploaded.firstWhere(
          (element) =>
              element.isBaseImage != null && element.isBaseImage == true,
          orElse: () => ImageObject());
      ...
      if (baseImage.id == null) {
        ...
        await _brandDataService.updateBrandBaseImage(
            widget.brandId, baseImage, null);
      }
      _imagesUploaded.removeWhere((element) =>
          element.isBaseImage != null && element.isBaseImage == true);
              ...
              slivers: [
                ...
                isLoading
                    ? SliverFillRemaining(
                        child: Center(
                            child: LoadingView(
                        //text: (context.l10n.loading.split(".")[0]+" "+context.l10n.photos.toLowerCase()+"...") + isLoadingTextExtra!,
                ...
                isLoading == false && _imagesUploaded.isEmpty
                    ? SliverFillRemaining(
                        hasScrollBody: false,
                        child: Column(
                          mainAxisAlignment: MainAxisAlignment.start,
                            ...
                            Padding(
                              ...
                              child: Row(
                                children: [
                                  Flexible(
                                    child: Text(
                                      "${context.l10n.noData.split(" ")[0]} ${context.l10n.photos.toLowerCase()}. ${context.l10n.yourImagesDescription.split("\n")[2]}",
                                      style:
                            ...
                            return Container(
                              ...
                              child: Stack(
                                children: <Widget>[
                                  ...
                                  /// Set Favorite Image
                                  canEdit && image.isBaseImage != true
                                      ? Positioned(
                                                  ...
                                                  onPressed: () async {
                                                    if (!brandIsActive) {
                                                      ...
                                                      if (image.isBaseImage !=
                                                              null &&
                                                          image.isBaseImage!) {
                                                        //topSnackBarComp.showSnackBarBottom(context, context.l10n.myImagesFavouriteDelete, 5, false);
                                                      } else if (canClickFav) {
                                                        var result =
                                                            await showDialog(
                                                                context:
                                                        ...
                                                        if (result) {
                                                          setState(() {
                                                            canClickFav = false;
                                                            _imagesUploaded[_imagesUploaded.indexWhere((element) =>
                                                                    element.isBaseImage !=
                                                                        null &&
                                                                    element.isBaseImage ==
                                                                        true)]
                                                      ...
                                                      if ((image.isBaseImage ==
                                                        ...
                                                        if (result) {
                                                          ...
                                                          setState(() {
                                                            isLoading = true;
                                                            isLoadingText =
                                                                "${context.l10n.deleting} ${context.l10n.photos.toLowerCase()}...";
                                                            isLoadingTextExtra =
                                                                " (${1}/${1})";
                                                          });
                                                          await _brandDataService
                                                        ...
                                                        var result =
                                                            await showDialog(
                                                                ...
                                                                builder: (_) {
                                                                  return DeleteConfirmationDialog(
                                                                      text:
                                                                          "${context.l10n.myImagesDeleteDescription}\n\n${context.l10n.yourImagesDescription.split("\n")[2]}");
                                                                });
                                                        if (result) {
                                                          mixpanel!.track(
                                                              'brand_images_delete');
                                  ...
                                  image.isBaseImage == true
                                      ? Positioned(
                                          top: MediaQuery.of(context)
                                                  ...
                                                  .width *
                                              0.038,
                                          right: _imagesUploaded.length == 1
                                              ? MediaQuery.of(context)
                                                      .size
                                                      .width *
                                                  0.16
            ...
            ? Padding(
                ...
                child: SizedBox(
                  ...
                  child: FloatingActionButton(
                    ...
                    backgroundColor: _imagesUploaded.length < _maxImages
