...
class _RegisterBrandMemberState extends State<RegisterBrandMember>
  ...
  Future<void> addUser() async {
    ...
    var result = await _userDataService.addUser(
    ...
    if (result == 0) {
      try {
        ...
        /// Get the User UID
        String? userUID = await _userDataService
            .getUserUIDWithEmail(emailController.text.trim());
        ...
        await _brandDataService.addUserToBrand(
            userUID, currentBrand.id!, role, true);
                            ...
                            children: [
                              ...
                              Material(
                                ...
                                child: Container(
                                  ...
                                  padding:
                                      const EdgeInsets.fromLTRB(18, 8, 6, 8),
                          ...
                          if (_selectedIndex == 0) {
                            ...
                            if (dayController.text.length == 2 &&
                              ...
                              if (confirmAge == false) {
                                ...
                                DateTime? date = convertToDate(
                                    dateString, "yyyy-MM-dd", context);
                                if (date == null ||
