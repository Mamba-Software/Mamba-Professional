...
class _Categories extends State<Categories> {
  ...
  List<String> categoriesFromBrand = [
    'Futbol',
    'Basket',
    'Tennis',
    'DS',
        ...
        child: Column(
          children: [
            ...
            Padding(
              ...
              child: Row(
                children: [
                  Text('Selecciona las categorias de tu marca',
                ...
                child: ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return Padding(
                        ...
                        child: categorySection(sportIcon[index], category,
                            sportColor[index], index),
                      );
                    }),
              ),
            ),
            ...
            Padding(
              ...
              child: Row(
                children: [
                  Text('Indica las palabras clave de tu marca',
                      style: Theme.of(context)
                          .textTheme
                          .displaySmall
                          ?.copyWith(fontWeight: FontWeight.w400),
