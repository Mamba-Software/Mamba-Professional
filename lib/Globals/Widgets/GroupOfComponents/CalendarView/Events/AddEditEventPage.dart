...
class AddEditEventPage extends StatefulWidget {
  ...
  AddEditEventPage({Key? key, this.initialDateTime, this.event}) : super(key: key);

  @override
  _AddEditEventPageState createState() => _AddEditEventPageState();
}

class _AddEditEventPageState extends State<AddEditEventPage> with SingleTickerProviderStateMixin{
  // Screen Dimensions
  var safeAreaHeight;
  var safeAreaWidth;
  bool isDark = false;
  ...
  // Init Add Event
  Future<void> initAddEvent() async {
    // Get Brand Details
    brand = await _brandDataService.getBrandDetails(currentBrand.id!);
    // Date Time Selected
    if (widget.initialDateTime != null) {
      startDateController.text = DateFormat('EEEE d/M/y - HH:mm', Localizations.localeOf(context).languageCode).format(widget.initialDateTime!);
      startDateController.text = StringUtils().toCapitalized(startDateController.text);
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(AppLocalizations.of(context)!.addEvent, style: Theme.of(context).appBarTheme.titleTextStyle,),
                                            ...
                                            Column(
                                              ...
                                              children: [
                                                ListTile(
                                                  ...
                                                  subtitle: Text(
                                                    AppLocalizations.of(context)!.until(StringUtils().toCapitalized(DateFormat('EEEE - d/M/yy', Localizations.localeOf(context).languageCode).format(oneWeek))),
                                                ...
                                                ListTile(
                                                  ...
                                                  subtitle: Text(
                                                    AppLocalizations.of(context)!.until(StringUtils().toCapitalized(DateFormat('EEEE - d/M/yy', Localizations.localeOf(context).languageCode).format(twoWeek))),
                                                    style: Theme.of(context).textTheme.caption,
                                                    textAlign: TextAlign.left,
                                                  ),
                                                  leading: Radio(
                                                ...
                                                ListTile(
                                                  ...
                                                  subtitle: Text(
                                                    AppLocalizations.of(context)!.until(StringUtils().toCapitalized(DateFormat('EEEE - d/M/yy', Localizations.localeOf(context).languageCode).format(oneMonth))),
                                                    style: Theme.of(context).textTheme.caption,
                                                    textAlign: TextAlign.left,
                                                  ),
                                                  leading: Radio(
