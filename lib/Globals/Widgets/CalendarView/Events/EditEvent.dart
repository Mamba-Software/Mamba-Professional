...
class EditEvent extends StatefulWidget {
  ...
  EditEvent({Key? key, required this.eventId, required this.locale}) : super(key: key);
...
class _EditEventState extends State<EditEvent> with SingleTickerProviderStateMixin{
  ...
  void getEventInfo(String id) async {
    ...
    getPlaceFullAddress(event!.placeId!);
  }
            ...
            children: [
              ...
              Padding(
                ...
                child: FloatingActionButton.extended(
                  ...
                  backgroundColor: _selectedIndex == 1 ? Colors.green : Theme.of(context).accentColor,
                  icon: Container(),
                  label: Text(
                    _selectedIndex == 1 ? AppLocalizations.of(context)!.editEvent : AppLocalizations.of(context)!.next,
