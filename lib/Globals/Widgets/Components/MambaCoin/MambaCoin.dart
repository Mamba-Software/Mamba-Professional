...
class MambaCoin {
  ...
  //Mmaba coin with value and or animation
  Widget mambaCoinStatic(var context, String? sessions, double? size, var image) {
    image = 'https://firebasestorage.googleapis.com/v0/b/mamba-style.appspot.com/o/mamba_logo.png?alt=media&token=a4307bd0-0c20-497f-abe7-0ada93129b85';
    return Container(
      height: 30,
      width: 30,
  ...
  Widget mambaCoinLogo(var context) {
    var image = 'https://firebasestorage.googleapis.com/v0/b/mamba-style.appspot.com/o/mamba_logo.png?alt=media&token=a4307bd0-0c20-497f-abe7-0ada93129b85';
    return Container(
      height: 30,
      width: 30,
      decoration: BoxDecoration(
