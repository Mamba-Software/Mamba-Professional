  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: () {
        ...
        if (bono.isActive! && widget.canExpand == true || widget.view! && widget.canExpand) {
          if (bonoSee == bono.id!) {
            bonoSee = 'nadie';
          } else {
            bonoSee = bono.id!;
...
/*
              ...
              */
/*
              !bono.isActive! && !widget.view! ? GestureDetector(
                onTap: () {
                  if(widget.view == false) {
                    bono.isActive = !bono.isActive!;
                    _brandDataService.updateBonoActive(
