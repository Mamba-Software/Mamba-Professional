...
class TextStyles {
  ...
  TextStyle blackBodyTextStyle() {
    return TextStyle(color: AppColors.black, fontSize: bodyText1, fontWeight: FontWeight.w500);
  }

  TextStyle greyBodyTextStyle() {
    return TextStyle(color: AppColors.darkGrey, fontSize: bodyText1);
  }

  TextStyle whiteBodyTextStyle() {
    return TextStyle(color: AppColors.white, fontSize: bodyText1);
  }
