      ...
      body: CustomScrollView(
        ...
        slivers: [
                            ...
                            child: SizedBox(
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  ClipOval(
                                    child: Material(
                                      color: hasOrder || hasFilter ? AppColors.white : Colors.transparent, // Button color
                                      child: InkWell(
                                        splashColor: Theme.of(context).backgroundColor, // Splash color
                                        onTap: () async {
                                                      ...
                                                      child: Padding(
                                                        ...
                                                        child: Column(
                                                          ...
                                                          children: [
                                                            ListTile(
                                                              title: Text(
                                                                  isFilterBy == false ? AppLocalizations.of(context)!.orderBy : AppLocalizations.of(context)!.filterBy,
                                        ...
                                        child: SizedBox(width: MediaQuery.of(context).size.width*0.09, height: MediaQuery.of(context).size.width*0.09, child: Icon(
                                          Icons.filter_list,
                                          color: hasOrder || hasFilter ? AppColors.darkGrey :  AppColors.white,
                                          size: MediaQuery.of(context).size.width*0.07,
                                        )),
                                      ),
                                    ),
          ...
          BlocProvider<ClientSessionsCubit>(
            lazy: false,
            create: (context) => ClientSessionsCubit(filteredMembers),
            child: BlocBuilder<ClientSessionsCubit, ClientsSessionsState>(
                      ...
                      delegate: SliverChildBuilderDelegate((
                        ...
                        return ListTile(
                          ...
                          subtitle: Column(
                            ...
                            children: [
                              Text(
                                user.lastEventAt == null ? AppLocalizations.of(
                                    context)!.lastActiveIn(DateTimeUtils()
                                    .formatDateTimeToStringMMMYYYY(
                                    dateJoined, Localizations
                                    .localeOf(context)
                                    .languageCode)) :
                          ...
                          trailing: user.id! == currentUser.id ? IconButton(
                            icon: Icon(Icons.arrow_forward_ios, color: Theme
                                .of(context)
                          ...
                          IconButton(
                            ...
                            child: Container(
                              ...
                              child: buildPlacesLeftWidget(int.parse(user.sessions!)),
                            ),
                          ),
                          onTap: () async {
