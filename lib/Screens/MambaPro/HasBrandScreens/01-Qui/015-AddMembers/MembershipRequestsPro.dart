                        ...
                        child: ListTile(
                          ...
                          title: RichText(
                            text: TextSpan(
                              ...
                              children: [
                                TextSpan(text: request.name!, style: Theme.of(context).textTheme.bodyMedium?.copyWith(fontWeight: FontWeight.bold),),
                                TextSpan(text: AppLocalizations.of(context)!.requestFromUser(type), style: Theme.of(context).textTheme.bodyMedium),
                              ],
                            ),
                          ),
                          subtitle: Column(
