...
class FeedBack extends StatefulWidget {
  final String title;
  const FeedBack({Key? key,required this.title}) : super(key: key);
                        ...
                        Tab(
                          child: Align(
                            ...
                            child: Row(
                              ...
                              children: [
                                SizedBox(width: 10,),
                                Text("Preguntas", style: Styles.purpleTextStyle.copyWith(fontWeight: FontWeight.bold),),
                              ],
                            ),
                          ),
                        ),
                        Tab(
                          child: Align(
                            ...
                            child: Row(
                              ...
                              children: [
                                SizedBox(width: 10,),
                                Text("Grupo de preguntas", style: Styles.purpleTextStyle.copyWith(fontWeight: FontWeight.bold),),
                              ],
                            ),
                          ),
                        ),
