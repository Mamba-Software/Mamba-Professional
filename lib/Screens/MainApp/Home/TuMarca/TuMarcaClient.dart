...
class TuMarcaClient extends StatefulWidget {
  const TuMarcaClient({Key? key}) : super(key: key);

  @override
  _TuMarcaClientState createState() => _TuMarcaClientState();
}

class _TuMarcaClientState extends State<TuMarcaClient> {
  // List Bool Status
      ...
      child: Column(
        children: [
          ...
          new Container(
            ...
            child: new Column(
              children: [
                Text("ROLDAN COACH", style: purpleTextStyle.copyWith(fontSize: 24, fontWeight: FontWeight.bold),),
                Padding(
