              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                      ...
                      child: Image.asset(Constants.createBrand)
                  ),
                ],
              ),
            ),
                    ...
                    onPressed: () async {
                      if (_selectedIndex == 0) {
                        ...
                        if (validateTime()) {
                          ...
                          var result = await _accessDatabase.addBrand(nameBrandController.text, _image, descriptionController.text, location.placeId!, location.description!, location.latitude!, location.longitude!, _workShift, members);
