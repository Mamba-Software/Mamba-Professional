...
import 'package:mamba_castelldefels/Globals/Widgets/Dialogs/ActionDialogs/DeleteConfirmationDialog.dart';
import 'package:mamba_castelldefels/Globals/Widgets/Images/FullScreenImageCarousel.dart';
...
class _AddBrandPicsState extends State<AddBrandPics> {
  ...
  Future<void> uploadPhotos() async {
    ...
    await _brandDataService.addBrandContentPictures(currentBrand.id!, _imagesToUpload!);
    _imagesToUpload = [];
    getBrandContentImages();
  }
                              ...
                              onPressed: () async {
                                ...
                                if (result) {
                                  ...
                                  await Future.delayed(const Duration(milliseconds: 1000), () async {
                                    await _brandDataService.deleteBrandContentPictures(currentBrand.id!, item.id!);
                                  });
                                  getBrandContentImages();
                                }
                              },
