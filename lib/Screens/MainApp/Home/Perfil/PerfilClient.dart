                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: Center(child: Text(AppLocalizations.of(context)!.planNewEvent, style: Theme.of(context).textTheme.headline3?.copyWith(color: AppColors.white,fontWeight: FontWeight.w400))),
                          ),
                        ],
                      ),
                    ),
