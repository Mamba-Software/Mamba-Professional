...
class SesionsPro extends StatefulWidget {
  SesionsPro({Key? key}) : super(key: key);

  @override
  _SesionsProState createState() => _SesionsProState();
}

class _SesionsProState extends State<SesionsPro> {
  // Screen Dimensions
  var safeAreaHeight;
  var safeAreaWidth;
  // Boolean Loading
