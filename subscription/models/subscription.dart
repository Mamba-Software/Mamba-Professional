...
class Subscription {
  ...
  Subscription.fromObjectAllData(
  ...
  Subscription.fromOfferingAllData(
      StoreProduct? storeProduct, String desc, Package _package) {
  ...
  Subscription.fromRevenueSubscription(var sub, String subId) {
    ...
    startDate =
        Timestamp.fromDate(DateTime.parse(sub['purchase_date']).toLocal());
