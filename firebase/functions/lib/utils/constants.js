...
exports.userCollection = admin.firestore().collection('TestUsers');
exports.brandCollection = admin.firestore().collection('TestBrands');
exports.chargeAmount = admin.firestore().collection('TestChargeAmount');
exports.invoicePaid = admin.firestore().collection('TestInvoicePaid');
exports.commonLogs = admin.firestore().collection('TestCommonLogs');
exports.bonos = 'TestBonos';
exports.stripeAccounts = admin.firestore().collection('temp_stripe_accounts');
